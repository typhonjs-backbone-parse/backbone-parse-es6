...
(function(factory) {
  module.exports = factory(require("underscore"), require("underscore"), require("parse"), require("underscore"), require("parse"), require("underscore"), require("jquery"), require("underscore"), require("underscore"), require("underscore"), require("underscore"), require("underscore"), require("underscore"), require("underscore"), require("underscore"), require("underscore"), require("underscore"), require("underscore"), require("underscore"));
});